...
__inline void CloseLeftoverPicker()
{
    if ( Colorpicker_Close ) ImGui::ClosePopup ( Colorpicker_Close );
}
                    ...
                    switch ( g_Options.LegitType )
                    {
                        ...
                        case 1:
                            ImGui::BeginChild ( "Backtracking", ImVec2 ( 250, 300 ), true );
                            {
                                ...
                                ImGui::Separator();
                                ImGui::Checkbox ( "BackTracking", &g_Options.misc_backtrack );
                                ImGui::SameLine();
                                ImGui::SliderFloat ( "Alpha", &g_Options.ChamsAlphaBT, 0.1f, 1.f, "%.1f Alpha" );
                                ImGui::SliderInt ( "Ticks", &g_Options.backtrackticks, 1, 12, "%.0f" );
                                ImGui::Checkbox ( "Backtrack Chams", &g_Options.backtrackchams );
                                ImGui::SameLine();
                                ColorPickerBox ( "##Picker_chams_players", g_Options.esp_player_chams_color_ctBT, g_Options.esp_player_chams_color_tBT, g_Options.esp_player_chams_color_ctBT, g_Options.esp_player_chams_color_tBT, false );
                                ...
                                ImGui::SliderFloat ( "##duration", &g_Options.HitboxDuration, 1.f, 10.0f, "Duration: %.2f /secs" );
                                ImGui::SameLine();
                                ImGuiEx::ColorEdit3 ( "##Hitbox", ( &g_Options.color_hitboxCol ) );
                        ...
                        switch ( g_Options.TypeOfESP )
                        {
                            case 0:
                                ...
                                ImGui::BeginChild ( "ESP MAIN", ImVec2 ( 220, 300 ), true );
                                {
                                    ...
                                    ImGui::SameLine();
                                    ImGuiEx::ColorEdit3 ( "##vis", &g_Options.color_esp_Box );
                                    ...
                                    ImGui::Checkbox ( "Skeleton", &g_Options.esp_player_Skel );
                                    ImGui::SameLine();
                                    ImGuiEx::ColorEdit3 ( "##Skeleton", &g_Options.color_Skel );
                                    ...
                                    ImGui::SameLine();
                                    ImGuiEx::ColorEdit3 ( "##Weaponsplayer", &g_Options.color_esp_playerweapons );
                                    ImGui::Checkbox ( "Names", &g_Options.esp_player_names );
                                    ImGui::SameLine();
                                    ImGuiEx::ColorEdit3 ( "##playername", &g_Options.color_esp_playername );
                                ...
                                ImGui::BeginChild ( "ESP Misc", ImVec2 ( 220, 300 ), true );
                                {
                                    ...
                                    ImGui::Checkbox ( "Recoil", &g_Options.RecoilCrosshair );
                                    ImGui::SameLine();
                                    ImGuiEx::ColorEdit3 ( "##Crosshairrecoil", &g_Options.color_esp_crosshair );
                                    ...
                                    ImGui::Checkbox ( "Flash ESP", &g_Options.esp_player_Flash );
                                    ImGui::SameLine();
                                    ImGuiEx::ColorEdit3 ( "##Flash ESP", &g_Options.FlashCol );
                                    ImGui::Checkbox ( "No Smoke ", &g_Options.esp_no_smoke );
                                    ImGui::Checkbox ( "Head ESP", &g_Options.HeadEsp );
                                    ImGui::SameLine();
                                    ImGuiEx::ColorEdit3 ( "##Head ESP", &g_Options.color_esp_HeadESP );
                            ...
                            case 1:
                                ...
                                ImGui::BeginChild ( "Glow", ImVec2 ( 220, 300 ), true );
                                {
                                    ...
                                    ImGui::SameLine();
                                    ImGuiEx::ColorEdit3 ( "##C4", &g_Options.color_glow_planted_c4 );
                                    ImGui::Checkbox ( "Defuse Kits", &g_Options.glow_defuse_kits );
                                    ImGui::SameLine();
                                    ImGuiEx::ColorEdit3 ( "##Defuse Kit", &g_Options.color_glow_defuse );
                                ...
                                ImGui::BeginChild ( "Chams", ImVec2 ( 500, 300 ) );
                                {
                                    ImGui::BeginChild ( "Chams", ImVec2 ( 166, 200 ) );
                                    {
                                        if ( ImGui::CollapsingHeader ( "Chams" ) )
                                        {
                                            ...
                                            ImGui::SameLine();
                                            ImGui::Checkbox ( "E", &g_Options.theirchams );
                                            ImGui::SameLine();
                                            ColorPickerBox ( "##E", g_Options.esp_player_chams_color_you, g_Options.esp_player_chams_color_you, g_Options.esp_player_chams_color_you, g_Options.esp_player_chams_color_you, false );
                                            ImGui::SameLine();
                                            ImGui::Checkbox ( "F", &g_Options.yourteamchams );
                                            ImGui::SameLine();
                                            ColorPickerBox ( "##T", g_Options.esp_player_chams_color_mine, g_Options.esp_player_chams_color_mine, g_Options.esp_player_chams_color_mine, g_Options.esp_player_chams_color_mine, false );
                                            ...
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Reg", &g_Options.chams_player_regular );
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Flat", &g_Options.chams_player_flat );
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Wire", &g_Options.chams_player_wireframe );
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "RegZ", &g_Options.chams_player_regular_IgnoreZ );
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "FlatZ", &g_Options.chams_player_flat_IgnoreZ );
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "WireZ", &g_Options.chams_player_wireframe_IgnoreZ );
                                    ...
                                    ImGui::BeginChild ( "Chams2", ImVec2 ( 166, 200 ) );
                                    {
                                        if ( ImGui::CollapsingHeader ( "Chams Arms" ) )
                                        {
                                            ...
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Wireframe Arms", &g_Options.chams_arms_wireframe ); //ImGui::SameLine(); ImGuiEx::ColorEdit4("!Vis", &g_Options.color_chams_arms_occluded);
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Flat Arms ", &g_Options.chams_arms_flat );
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Ignore-Z Arms", &g_Options.chams_arms_ignorez );
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Glass Arms", &g_Options.chams_arms_glass );
                                    ...
                                    ImGui::BeginChild ( "Chams3", ImVec2 ( 166, 200 ) );
                                    {
                                        if ( ImGui::CollapsingHeader ( "Chams Weapons" ) )
                                        {
                                            ...
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Wireframe Weapon", &g_Options.chams_wep_wireframe );
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Flat Weapon", &g_Options.chams_wep_flat );
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Ignore-Z Weapon ", &g_Options.chams_wep_ignorez );
                                            ImGui::Bullet();
                                            ImGui::SameLine();
                                            ImGui::Selectable ( "Glass Weapon", &g_Options.chams_wep_glass );
